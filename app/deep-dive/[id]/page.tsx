...
export default function DeepDivePage() {
    ...
    useEffect(() => {
        const loadNode = async () => {
            ...
            if (found) {
                setNode(found);
                // Initial AI Greeting
                setMessages([{ role: "ai", content: `Welcome to the core of '${found.title}'. I'm here to provide a deep dive into this topic. What would you like to explore?` }]);
            } else {
                router.push("/");
            }
        };
    ...
    if (!node) return <div className="h-screen w-full bg-black flex items-center justify-center text-cyan-400 font-mono">LOADING_NEURAL_PATH...</div>;
        ...
        <main className="relative h-screen w-full bg-[#020408] overflow-hidden flex">
            ...
            <div className="absolute inset-0 z-0">
                <Canvas camera={{ position: [0, 0, 15] }}>
                    ...
                    <ImmersivePlanet planetType={node.planet_type || "generic"} />
